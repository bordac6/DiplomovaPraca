...
print(green)
print(blue)
print('r: {}; g: {}; b: {}'.format((red/train_val_treshold)/255.0, (green/train_val_treshold)/255.0, (blue/train_val_treshold)/255.0))
